...
pub contract KittyItems: NonFungibleToken {
	...
	init() {
        // Set our named paths
        self.CollectionStoragePath = /storage/HTYNFTCollection016
        self.CollectionPublicPath = /public/HTYNFTCollection016
        self.MinterStoragePath = /storage/HTYNFTMinter016
