...
pub contract KittyItems: NonFungibleToken {
	...
	init() {
        // Set our named paths
        self.CollectionStoragePath = /storage/HTYNFTCollection009
        self.CollectionPublicPath = /public/HTYNFTCollection009
        self.MinterStoragePath = /storage/HTYNFTMinter009
