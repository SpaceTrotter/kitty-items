...
pub contract KittyItems: NonFungibleToken {
	...
	init() {
        // Set our named paths
        self.CollectionStoragePath = /storage/HTYNFTCollection010
        self.CollectionPublicPath = /public/HTYNFTCollection010
        self.MinterStoragePath = /storage/HTYNFTMinter010
