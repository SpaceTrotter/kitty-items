...
pub contract KittyItems: NonFungibleToken {
	...
	init() {
        // Set our named paths
        self.CollectionStoragePath = /storage/HTYNFTCollection011
        self.CollectionPublicPath = /public/HTYNFTCollection011
        self.MinterStoragePath = /storage/HTYNFTMinter011
