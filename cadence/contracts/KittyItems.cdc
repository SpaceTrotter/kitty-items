...
pub contract KittyItems: NonFungibleToken {
	...
	init() {
        // Set our named paths
        self.CollectionStoragePath = /storage/HTYNFTCollection012
        self.CollectionPublicPath = /public/HTYNFTCollection012
        self.MinterStoragePath = /storage/HTYNFTMinter012
