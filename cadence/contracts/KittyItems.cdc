...
pub contract KittyItems: NonFungibleToken {
	...
	init() {
        // Set our named paths
        self.CollectionStoragePath = /storage/HTYNFTCollection013
        self.CollectionPublicPath = /public/HTYNFTCollection013
        self.MinterStoragePath = /storage/HTYNFTMinter013
